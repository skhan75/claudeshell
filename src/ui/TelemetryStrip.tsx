...
export function TelemetryStrip() {
  ...
  // FIX 1: show the effective model — fall back to the configured default until
  // the SDK init message populates meta.model on the first turn.
  ...
  const coreText = ` ${model}${SEP}${fmtK(u.inputTokens)}/${fmtK(u.outputTokens)} [${bar(ctxPct, 5)}]${SEP}$${u.costUsd.toFixed(2)}`;
